...
경제학을 공부하며, 채용 시장에서 정보의 비대칭성 문제에 대해 배웠습니다. 고용주와 피고용인 간에 정보가 완전히 공유되지 않아 종종 잘못된 결정이 내려진다는 이론입니다. 이러한 문제를 방지하기 위해, 저는 포트폴리오에 가능한 많은 정보를 담으려고 노력했습니다. 이는 제가 지향하는 투명성과 신뢰성을 반영합니다. 😄
...
- 📅 2019.3 - 2020.2, (2020 - 2021 🪖 군 휴학), 2022.3 - 2023.2
...
- 캐나다 몬트리올 소재 공립 대학. 입학 당시 QS 세계 대학 랭킹 18위
- 2014.9 - 2018.6
- GPA 3.11 / 4.0 (총 121학점)
...
- 2011.03 - 2011.06 (이사로 인한 중퇴)

## 📚 교육 프로그램

### 🎓 네이버 커넥트재단 부스트캠프 웹・모바일 8기 수료
...
- 소개: 평소 트위치에서 해외 개발자들이 'LeetRooms'라는 크롬 익스텐션을 활용해 시청자들과 함께 알고리즘 대결을 펼치는 모습을 보며, 같은 경험을 한국인들과도 공유하고 싶다는 생각을 자주 했습니다. 이런 생각을 바탕으로, 네이버 부스트캠프에서 만난 훌륭한 동료들과 손을 잡고 '백준룸즈' 프로젝트를 시작했습니다.
  ...
  알고리즘 학습에 몰두하는 학생들 사이에서 인기 있을 거라고 확신합니다!

<!-- ## 부족한 역량 & 앞으로 개선해 나아갈 사항

### Redis

- 세션 로그인을 구현할 때 Redis를 사용해봤지만, 깊게 공부해보지는 않았어요.

### SQL Query 최적화

- Real MySql 8.0 1권을 읽어봤지만, 아직 SQL EXPLAIN, EXPLAIN ANALYZE, slow query, general query를 실전에서 깊게 탐구해본 적이 없어요.
- DB partitioning / sharding

### CSS

- 간단한 Flexbox 사용법, Specificity 안된다 정도밖에 몰라요.
- 그래도 [이 블로그 글](https://velog.io/@dkvlg/TOAST-UI-Editor%EC%99%80-Tailwind%EC%97%90%EC%84%9C-toolbar-icon%EC%9D%B4-%EB%82%98%ED%83%80%EB%82%98%EC%A7%80-%EC%95%8A%EB%8A%94-%EB%AC%B8%EC%A0%9C)에 적힌 것처럼 프론트 개발자를 도와 디버깅할 수 있는 역량은 있어요.
...
- Squash Merge를 사용하도록 팀원들을 아래 사진과 같이 설득한 적이 있어요.
  ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/6eb95ea0-ceaf-4f0e-942c-01d2d6582398/ef000008-be1a-4689-be48-56a4763cc2d5/Untitled.png)
...
매주 일요일마다 꾸준히 기술서적 완독 스터디를 진행한지 1년 2개월 정도 흘렀어요. [링크](https://github.com/vimkim#%EC%8A%A4%ED%84%B0%EB%94%94)
...
명절을 제외하고는 한 주도 빠지지 않고 모두 꾸준히 성실하게 참여해주셨어요.
